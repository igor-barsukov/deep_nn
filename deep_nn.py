...
def main():
    # test_init_params()
    # test_init_params_deep()
    # test_linear_forward()
    # test_linear_activ_forward()
    # test_l_model_forward()
    # test_compute_cost()
    # test_linear_backward()
    # test_linear_activ_backward()
...
def L_model_forward(X, parameters):
    ...
    W_L = parameters['W' + str(L)]
    b_L = parameters['b' + str(L)]
    AL, cache = linear_activation_forward(A, W_L, b_L, "sigmoid")
    caches.append(cache)
...
def test_linear_activ_backward():
